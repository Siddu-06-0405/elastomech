...
const FAQCP = () => {
    ...
    return (
        <div className="bg-white min-h-screen">
            <SEO title="FAQ-CABLE-PROTECTORS by Elastomech"
            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="border border-yellow-500 rounded-lg overflow-hidden shadow-md mb-4">
                    ...
                    {openIndex === 1 && (
                        <div className="p-4 bg-yellow-100 text-black">
                            Elastomech provides a wide range of cable protectors, including rubber cable protectors etc. More details can be found <a href='https://www.elastomech.in/products/cable-protectors' className='text-blue-700' >here</a>.
                        </div>
                    )}
                </div>
                ...
                <div className="border border-yellow-500 rounded-lg overflow-hidden shadow-md mb-4">
                    ...
                    {openIndex === 4 && (
                        <div className="p-4 bg-yellow-100 text-black">
                            ...
                            <li><b>Load-bearing capacity:</b> Match it to pedestrian or vehicular traffic.
                            </li>
                    ...
                    {openIndex === 5 && (
                        <div className="p-4 bg-yellow-100 text-black">
                            <ol className="list-decimal pl-6 mt-2 space-y-1 text-gray-800">
                                ...
                                <li><b>Split-top cable protectors</b>: Easy to insert cables.
                                </li>
